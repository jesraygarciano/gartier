    ...
    <sidebar-popup ref="application-detail-modal">
      <div v-if="company" class="contents">
        <div class="photos-container">
          ...
          <button type="button" style="position:absolute; top: 0px; right: 0px;" v-on:click="closeCollaboratorModal" class="btn btn-light">
        ...
        <div class="p-15">
          ...
          <div class="card mb-3" v-for="(collaborator, index) in collaborators" v-bind:key="index">
            ...
            <div class="card-footer text-muted">
              ...
              <button class="btn btn-light pull-right" v-on:click="prep_remove_collaborator(collaborator,index)">
